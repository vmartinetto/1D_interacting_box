...
#occs = [[2],[1,1],[0,2],[0,1,1],[0,0,2],[0,0,1,1]] ignorant occupation ordering
#occs = [[2],[1,1],[1,0,1],[0,2,0],[0,1,1],[0,0,2]] # ordered by energy for the ionization inversion
occs = [[2],[1,1],[1,1],[1,0,1],[1,0,1],[0,2,0],[0,1,1],[0,1,1],[0,0,2]] # ordered including industiguishaility of particles
states = len(occs)
...
print(overlap)
np.savetxt('ks_dens_ION_1001-9-2030.dat',dens,fmt='%.9e', delimiter=' ')
